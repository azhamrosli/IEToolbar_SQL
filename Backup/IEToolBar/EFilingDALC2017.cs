...
namespace IEToolBar
{
    public class EFilingDALC2017 : EFilingDAL
    {
        ...
        public DataSet GetFormDataC2017(string strPage)
        {
            ...
            try
            {
                ...
                switch (strPage)
                {
                    case "C2017Page1":
                        ...
                        break;
                    case "C2017Page2":
                        errorLog = "P2_INPUT_DIRECTORS";
                        //0 dir_name, 
                        //1 dir_ic, 
                        //2 dir_tel_no, 
                        //3 dir_reftype, 
                        //4 dir_refnum+dir_refnum2+dir_refnum3, 
                        //5 dir_equity, dir_salary, 
                        //6 dir_allow, 
                        //7 dir_loan_to, 
                        //8 dir_loan_from, 
                        //9 dir_date_of_birth
                        //9 left(format(dir_date_of_birth,'dd/mm/yyyy'),2), 
                        //mid(format(dir_date_of_birth,'dd/mm/yyyy'), 4, 2), 
                        //right(format(dir_date_of_birth,'dd/mm/yyyy'),4)
                    ...
                    case "C2017Page3":
                        ...
                        errorLog = "P3_SYER";
                        strQuery = "SELECT s.SH_IC, s.SH_NAME, iif(cast(b.bs_capital as money) > 0,(s.sh_share*s.sh_par_value/b.bs_capital)*100,0), s.SH_COUNTRY, s.SH_CHECK, s.SH_SHAREP, s.SH_DATE_OF_BIRTH FROM shareholders_profile AS s, balance_sheet AS b WHERE s.SH_REF_NO=b.bs_ref_no AND s.SH_YA=b.BS_YA AND s.SH_REF_NO=? AND S.SH_YA=? order by s.sh_order";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
                    ...
                    case "C2017Page4":
                        ...
                        else
                        {
                            ...
                            errorLog = "P5_PARTNERSHIP_INCOME";
                        ...
                        break;
                    case "C2017Page5":
                        errorLog = "P11_OTHER_EXPENDITURE";
                    ...
                    case "C2017Page9":
                        ...
                        errorLog = "P4_NON_TAXALBE_PROFITS";
                    ...
                    case "C2017Page15":
                        ...
                        errorLog = "P20_RKT_RKS_ACCPERIOD";
            ...
            {
                System.Windows.Forms.MessageBox.Show("AAAA " + ex.ToString() + errorLog);
            }
            return dsData;
        }
