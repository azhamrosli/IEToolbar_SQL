            ...
            try
            {
                ...
                switch (strPage)
                {
                    case "C2014Page1":
                        ...
                        strQuery = "select t.tp_residence, t.tp_country, t.tp_public_order, t.tp_co_status, t.tp_reg_state, t.tp_curr_state, t.tp_com_state, b.bk_code, t.tp_record_kept, t.tp_alt_state, substring(convert(nvarchar(20), t.tp_acc_period_fr, 103),1,2), substring(convert(nvarchar(20), t.tp_acc_period_fr, 103), 4, 2), right(convert(nvarchar(20), t.tp_acc_period_fr, 103),4), substring(convert(nvarchar(20), t.tp_acc_period_to, 103),1,2), substring(convert(nvarchar(20), t.tp_acc_period_to, 103), 4, 2), right(convert(nvarchar(20), t.tp_acc_period_to, 103),4), " + 
						"right(convert(nvarchar(10), t.tp_basis_period_fr, 112), 2), substring(convert(nvarchar(10), t.tp_basis_period_fr, 112), 5,2), substring(convert(nvarchar(10), t.tp_basis_period_fr, 112), 1,4), right(convert(nvarchar(10), t.tp_basis_period_to, 112), 2), substring(convert(nvarchar(10), t.tp_basis_period_to, 112), 5,2), substring(convert(nvarchar(10), t.tp_basis_period_to, 112), 1,4), right(convert(nvarchar(10), t.tp_opn_operation, 112), 2), substring(convert(nvarchar(10), t.tp_opn_operation, 112), 5,2), substring(convert(nvarchar(10), t.tp_opn_operation, 112), 1,4), tp_reg_country, tp_curr_country, tp_com_country, tp_alt_country from taxp_profile t, bank b where tp_ref_no=?";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer.ToString()));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
